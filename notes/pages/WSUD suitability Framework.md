...
- ## Table 4 — "A place needs WSUD"
  *Factors determining suitability from the perspective of a location's needs, organised by ecosystem services*
  ...
  | Ecosystem Function | Ecosystem Service | Indicators | Explanation | Scale variability |
  |---|---|---|---|---|
  | **Provisioning** | Food production | Lifestyle, malnutrition levels | WSUD can support urban agriculture through irrigation; more relevant where food insecurity is high | Precinct – between cities |
  | | Fresh water supply | Households with potable/non-potable access, proximity to demand, demand vs supply, reliance on non-replenishable sources | Areas with water scarcity benefit most from WSUD that harvests or recycles stormwater | Neighbourhood – between cities |
  | **Regulating** | Gas regulation | Levels of air pollution, CO₂ equivalent | Urban vegetation in WSUD can filter air pollutants and sequester some carbon | Exact location – between cities |
  | | Climate regulation | Relative temperature increase, extreme heat days, heat-related mortalities | Areas suffering from urban heat island effect benefit from the cooling of green/blue WSUD elements | Exact location – between cities |
  | | Water regulation (urban drainage) | Connected impervious area, flow regime, presence and capacity of centralised drainage | Where existing drainage is overwhelmed or absent, WSUD is most needed to manage stormwater flows | Neighbourhood – between cities |
  | | Water purification | Water quality of receiving waters, land use, sewage discharge, combined sewer overflows | Areas with polluted runoff or degraded waterways have the highest need for WSUD treatment | Neighbourhood |
  | | Natural hazard (flood control) | Observed flood occurrence, flood risk from models | Flood-prone areas are priority locations for WSUD that detains and attenuates stormwater | Exact location – between cities |
  | **Cultural** | Aesthetic/educational values | Street activity/visibility, vicinity to civic land uses | Visible WSUD in busy public spaces educates residents and provides amenity; less benefit if hidden | Exact location |
  | | Social relations | Age, income, population density, education, volunteering, antisocial behaviour rates | Demographic factors influence how much a community will benefit socially from green public spaces | Precinct – neighbourhood |
  | | Recreation | Proximity to green open space | Areas lacking nearby parks or nature benefit most from WSUD that doubles as accessible green space | Exact location |
  | **Habitat / Supporting** | Refuge habitat | Green space provision levels, protection status, connectedness, biodiversity, species population size | Areas with fragmented or depleted urban ecology benefit most from WSUD that builds ecological networks | Neighbourhood – between cities |
-
-
-
- ---
